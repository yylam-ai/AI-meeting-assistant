...
parser.add_argument('--audio_input_prediction', default=['audio_clip_cafe.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='denoise_audio_clip_cafe.wav', type=str)
